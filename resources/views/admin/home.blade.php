...
@section('content')
    ...
    const getTarget = (() => {
        ...
        return function getTarget() {
            ...
            let health = 1;
            let maxHealth = 3;
            const spinner = state.game.cubeCount >= spinnerThreshold && isInGame() && spinnerSpawner
                .shouldSpawn();
    ...
    const createBurst = (() => {
        ...
        return (target, force = 1) => {
            ...
            transformVertices(
                ...
                target.rotateX - target.rotateXD, target.rotateY - target.rotateYD, target.rotateZ -
                target.rotateZD,
                1, 1, 1
            );
